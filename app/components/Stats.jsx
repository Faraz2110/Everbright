...
const stats = [
  {
    ...
    description:
      "We work with 15+ top brands to install and service quality air conditioning systems.",
  },
  {
    number: "300+",
    label: "Loyal Customers",
    description:
      "Over 300 customers trust us for reliable air conditioning solutions and support.",
  },
  {
    number: "2,000+",
    label: "ACs Installed",
    description:
      "We have installed over 2,000 air conditioning units in homes and businesses of all sizes.",
  },
];
