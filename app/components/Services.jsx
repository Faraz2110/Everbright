    ...
    >
      ...
      <div className="relative z-10 grid gap-8 sm:grid-cols-2 w-full max-w-6xl">
        {categories.map((category, index) => (
          <motion.div
            key={index}
            className="bg-black/70 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-gray-800 hover:border-cyan-500 transition duration-300"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <ul className="pl-4 list-disc text-gray-300 space-y-2">
