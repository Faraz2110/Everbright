...
export default function About() {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <ul className="space-y-4 text-gray-300">
            {[
              ...
              <motion.li key={idx} className="flex items-center gap-3 hover:text-cyan-400 transition" variants={fadeUpVariant}>
      ...
      {/* Right Illustration as card-style images */}
      <motion.div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
        {/* Main Image Card */}
        <motion.div
          className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-800 cursor-pointer"
          initial="hidden"
        ...
        {mainLoaded && (
          <motion.div
            className="relative rounded-2xl overflow-hidden shadow-lg border border-cyan-500 cursor-pointer"
